...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a list of banners' do
      banner1 = Banner.create(start_date: Date.today, end_date: Date.tomorrow, location: "Banner1", headline: "Banner1", subcopy: "Banner1", image: "/images/sheeper.jpg", user_id: @user.id)
      banner2 = Banner.create(start_date: Date.today, end_date: Date.tomorrow, location: "Banner2", headline: "Banner2", subcopy: "Banner2", image: "/images/sheeper.jpg", user_id: @user.id)
      visit banners_path
